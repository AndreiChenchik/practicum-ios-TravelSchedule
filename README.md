...
- [ ] tabbar, показывающий два основных экрана: поиск и настройки;
- [ ] навигация типа master-detail между всеми экранами в дизайне;
- [ ] сториз, которые открываются модально. 

Self-check:

- [ ] Создан tabbar для переключения между главным экраном поиска поездок и экраном настроек.
- [ ] В момент начала поиска организован полноэкранный показ выбора города с помощью `.fullScreenCover()`.
- [ ] После выбора города реализован переход на экран выбора станции.
- [ ] После выбора станции реализован возврат назад на главный экран.
- [ ] При навигации на экраны выбора города и станции tabbar не отображается.
- [ ] По нажатии на кнопку «Найти» происходит переход на экран выбора поездки.
- [ ] По нажатию на «Уточнить время» происходит переход на экран выбора временных интервалов.
- [ ] С экрана «Уточнить время» можно вернуться назад с помощью стрелки или по кнопке «Применить».
- [ ] При выборе поездки открывается экран с детальной информацией о перевозчике с возможностью возврата назад.
- [ ] При нажатии на сторис на главном экране они открываются в модальном окне.
- [ ] Везде есть возможность вернуться на предыдущий экран.
